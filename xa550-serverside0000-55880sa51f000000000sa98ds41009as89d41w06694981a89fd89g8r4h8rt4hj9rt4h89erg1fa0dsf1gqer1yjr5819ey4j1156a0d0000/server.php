...
if (file_exists($filePath)) {
    ...
    foreach ($submissions as $reverseIndex => $submission) {
        ...
        $actualIndex = count($submissions) - $reverseIndex - 1;

        echo "<div class='submission'>";
        echo "<h3>Submission " . ($actualIndex + 1) . "</h3>";
        echo "<p><strong>Name:</strong> $name</p>";
        echo "<p><strong>Email:</strong> $email</p>";
        echo "<p><strong>Subject:</strong> $subject</p>";
        echo "<p><strong>Message:</strong> $message</p>";
        echo "<p><span class='show-details' data-index='$actualIndex'>Advanced Details</span></p>";
        echo "<div class='advanced-details' id='details-$actualIndex'>";
        echo "<p><strong>Date:</strong> $date</p>";
        echo "<p><strong>IP Address:</strong> $ip</p>";
        echo "</div>";
        echo "<form method='post'>
                  <input type='hidden' name='delete_index' value='$actualIndex'>
